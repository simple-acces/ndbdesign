...
<div class="nav-container">
	...
	<nav id="menu1" class="bar bar--sm bar-1 hidden-xs hiddem-sm bar--dark bar--transparent bar--absolute <?php echo esc_attr($background); ?>" <?php echo wp_kses_post($scroll); ?>>
		<div class="container">
			<div class="row">
