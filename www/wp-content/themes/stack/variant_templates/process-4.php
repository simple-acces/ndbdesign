<!--META--><section class="vim" id="variant-process-4" vbr="Process 4" vbp="process">
<section class="switchable ">
    
    <div class="container">
        <div class="row">
            <div class="col-sm-6 text-center wysiwyg">
                <img alt="Image" class="border--round box-shadow-wide" src="<?php variant_page_builder_demo_img('cowork-11.jpg'); ?>">
            ...
            <div class="col-sm-6 col-md-5">
                <ol class="process-3">
                    <li class="process_item">
                        ...
                        <div class="process__body wysiwyg">
                    ...
                    <li class="process_item">
                        ...
                        <div class="process__body wysiwyg">
                            ...
                            <p>
                            Select from over 280 interface blocks, customise the look to build your perfect page.
                            </p>
                        </div>
                    </li>
                    <li class="process_item">
