<!--META--><section class="vim" id="variant-accordion-video-2-bg" vbr="Accordion Video 2 BG" vbp="accordion">
		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-6">
				<div class="video-cover border--round box-shadow">
					<div class="background-image-holder">
						<img alt="image" src="<?php variant_page_builder_demo_img('agency-2.jpg'); ?>">
					</div>
