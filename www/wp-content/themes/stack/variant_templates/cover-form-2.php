<!--META--><section class="vim" id="variant-cover-form-2" vbr="Cover Form 2" vbp="covers">
<section class="cover imagebg height-70 text-center" data-overlay="4">
	<div class="background-image-holder"><img alt="background" src="<?php variant_page_builder_demo_img('tourism-1.jpg'); ?>"></div>
	<div class="container pos-vertical-center">
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="boxed boxed--lg bg--white text-left cf7-holder">
