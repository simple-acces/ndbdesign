<!--META--><section class="vim" id="variant-accordion-slider-2-bg" vbr="Accordion Slider 2 BG" vbp="accordion">
			...
			<div class="col-md-6 col-sm-6 variant-disable-vjr">
				<div class="slider box-shadow-wide border--round variant-disable-vjr" data-arrows="true" data-paging="true">
					<ul class="slides variant-disable-vjr">
						<li>
							<img alt="img" src="<?php variant_page_builder_demo_img('work-1.jpg'); ?>">
						</li>
						<li>
							<img alt="img" src="<?php variant_page_builder_demo_img('work-2.jpg'); ?>">
						</li>
						<li>
							<img alt="img" src="<?php variant_page_builder_demo_img('work-3.jpg'); ?>">
						</li>
					</ul>
				</div>
			</div>
