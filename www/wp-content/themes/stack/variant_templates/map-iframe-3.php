<!--META--><section class="vim" id="variant-map-iframe-3" vbr="Map Iframe 3" vbp="contact">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-xs-12">
                ...
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-xs-12 col-xs-12 col-xs-offset-0 wysiwyg">
