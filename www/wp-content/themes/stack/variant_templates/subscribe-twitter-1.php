<!--META--><section class="vim" id="variant-subscribe-twitter-1" vbr="Subscribe Twitter 1" vbp="subscribes">
<section class="switchable ">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 col-sm-6">
                <div class="tweets-feed tweets-feed-2" data-feed-name="tommusrhodus" data-amount="4"></div>
            </div>  
        </div><!--end of row-->
