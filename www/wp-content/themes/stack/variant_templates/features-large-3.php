<!--META--><section class="vim" id="variant-features-large-3" vbr="Features Large 3" vbp="features large">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-xs-12 text-center">
                <img alt="Image" src="<?php variant_page_builder_demo_img('device-1.png'); ?>">
            </div>  
        </div><!--end of row-->
